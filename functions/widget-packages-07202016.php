...
function randgroupPackages($atts, $content = null) {
	...
	function row($label, $col1, $col2, $col3) {
		...
		if (isset($col1)) {$col1_properties = $col1;} else { $col1_properties = "checked disabled";}
		if (isset($col2)) {$col2_properties = $col2;} else { $col2_properties = "checked disabled";}
		if (isset($col3)) {$col3_properties = $col3;} else { $col3_properties = "checked disabled";}
				  ...
				  <div class="accordion-group">
					...
					<div id="Email1" class="accordion-body collapse in">
					  <div class="accordion-inner">
						...
						<input type="checkbox" checked disabled> <a href="" data-toggle="tooltip" title="Powered by Microsoft">Email</a>
						</label>
						<label class="checkbox">
						<input type="checkbox" checked disabled> <a href="" data-toggle="tooltip" title="Fine print goes here">Cloud Storage</a>
						</label>
						<label class="checkbox">
...
<div class="span10 offset1">
	...
	<h2><?php echo $headline; ?></h2>
		...
		<table id="table-packages" class="table table-bordered table-fixed table-hover">
			<thead>
						<tr>
						  ...
						  <th><span class="text-center label label-inverse" style="width:150px;"><h5>Office 365<br/>E3</h5></span></th>
		...
		?>
                ...
                <tr>
					<td>Compliance solutions to support archiving, auditing and eDiscovery, mailbox and internal site search and legal hold</td>
