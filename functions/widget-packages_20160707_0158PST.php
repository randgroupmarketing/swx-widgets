	...
	<h2><?php echo $headline; ?></h2>
		...
		<table id="table-packages" class="table table-bordered table-fixed table-hover">
			...
			<tbody>
				...
				// example
				// row('Unlimited Email','disabled','','checked');
				//row('Unlimited Email','disabled','','checked');
                ...
                <tr>
					<td>Unlimited email storage for in-place archive</td>
					<td><input type="checkbox" checked disabled></td>
					<td><input type="checkbox" checked disabled></td>
					<td><input type="checkbox" checked disabled></td>
				</tr>				
				...
				<tr>
					<td>Unlimited online meetings, IM, and audio, HD video, and web conferencing</td>
					<td><input type="checkbox" disabled></td>
					<td><input type="checkbox" checked disabled></td>
					<td><input type="checkbox" checked disabled></td>
				</tr>
